                                    ...
                                    @foreach ($daftarReseller as $daftarreseller)
                                        <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                            <div class="d-flex flex-column">
                                                ...
                                                <span class="mb-2 text-xs">Alamat Gudang: <span
                                                        class="text-dark ms-sm-2 font-weight-bold">{{ $daftarreseller->gudang }}</span></span>
                                            </div>
                                            <div class="ms-auto text-end">
                                                <form action="dashboard/delete/{{ $daftarreseller->id }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
