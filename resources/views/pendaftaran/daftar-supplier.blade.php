    ...
    <section id="hero" class="hero d-flex align-items-center position-relative">
        ...
        <div class="container px-5">
            ...
            <header class="section-header">
                <h2>daftar</h2>
                <p>Form Pendaftaran Supplier</p>
            </header>
            <div class="row">
                <form action="daftar-supplier/store" method="POST">
                    @csrf
                    ...
                    <div class="form-group row mt-3">
                        <label for="alamat-gudang" class="col-sm-2 col-form-label">Alamat Gudang</label>
                        <div class="col-sm-10">
                            <input name="alamat-gudang" type="text" class="form-control" id="alamat" placeholder="" />
                        </div>
                    </div>
